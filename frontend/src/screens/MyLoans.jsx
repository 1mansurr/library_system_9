        ...
        {!loading && tab === 'active' && (
          <div style={{ display: 'flex', flexDirection: 'column', gap: 14 }}>
            ...
            {active.map(ln => {
              ...
              const accentColor = overdue ? 'var(--bad-fg)' : 'var(--primary)';
            ...
            {past.map(ln => {
              ...
              return (
                <div key={ln.loan_id} style={{ display: 'flex', alignItems: 'center', gap: 16, padding: '17px 22px', borderBottom: '1px solid var(--border)' }}>
                  ...
                  <span style={{ display: 'inline-flex', alignItems: 'center', padding: '4px 11px', borderRadius: 7, font: '600 11.5px var(--ui)', background: 'var(--ok-bg)', color: 'var(--ok-fg)' }}>
                    Returned
                  </span>
                </div>
              );
